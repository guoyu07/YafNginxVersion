...
class Bootstrap extends Yaf_Bootstrap_Abstract {
    ...
    public function _initRoute(Yaf_Dispatcher $dispatcher) {
        ...
        $customRoute = new Yaf_Route_Regex(
            '#^\/api\/short\/custom/?\??(.*)#',
            array(
                'controller' => 'Short',
                'action' => 'custom'
        ...
        $router->addRoute('shortenRoute', $shortenRoute);
        $router->addRoute('expandRoute', $expandRoute);
        $router->addRoute('customRoute', $customRoute);
    }
